 ...
 * and environment detection. Subclasses handle specific reporting formats.
 *
 * ## Features
 *
 ...
 * - **CI detection**: Automatically detects CI environments and switches to Markdown mode
...
export class TstycheBaseReporter {
  ...
  constructor (resolvedConfig) {
    ...
    const useMarkdown = this.#detectCiEnvironment();
  ...
  #detectCiEnvironment () {
    ...
    // eslint-disable-next-line n/no-process-env -- CI detection
